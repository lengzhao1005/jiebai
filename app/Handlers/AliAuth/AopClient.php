...
class AopClient
{
    ...
    {
        $this->gatewayUrl= config('alipay.gatewayUrl');
        $this->appId= config('alipay.appId');
        $this->rsaPrivateKey= config('alipay.rsaPrivateKey');//应用私钥
        $this->alipayrsaPublicKey= config('alipay.alipayrsaPublicKey');//支付宝公钥
        $this->apiVersion= config('alipay.apiVersion');
        $this->signType= config('alipay.signType');
        $this->postCharset= config('alipay.postCharset');
